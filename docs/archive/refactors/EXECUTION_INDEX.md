...
- `docs/refactors/RelatÃ³rio tÃ©cnico para implementaÃ§Ã£o no Projeto Jubileu.md`
- `docs/refactors/InvestigaÃ§Ã£o tÃ©cnica do Projeto Jubileu para plan e slices executÃ¡veis.md`
...
- `docs/refactors/Frontend/07-Desmembramento de Arquivos e ReduÃ§Ã£o de Acoplamento.md`
