...
| `PUT` | `/api/dias/{data_iso}/eventos/{evento_id}/partidas/{partida_id}/jogadores/{jogador_evento_id}/stats` |
...
| `POST` | `/dias/{data_iso}/eventos/{evento_id}/finish` |
...
| `POST` | `/dias/{data_iso}/eventos/{evento_id}/start` |
...
| `PUT` | `/dias/{data_iso}/eventos/{evento_id}/finish` |
...
| `PUT` | `/dias/{data_iso}/eventos/{evento_id}/partidas/{partida_id}/end` |
| `PUT` | `/dias/{data_iso}/eventos/{evento_id}/partidas/{partida_id}/jogadores/{jogador_evento_id}/stats` |
| `PUT` | `/dias/{data_iso}/eventos/{evento_id}/partidas/{partida_id}/start` |
| `PUT` | `/dias/{data_iso}/eventos/{evento_id}/start` |
