...
| `uc10-dashboard.spec.ts` | UC10 dashboard/indicadores | created-e2e/blocked-e2e | Spec criada para validar indicadores ou estado operacional vazio/erro. |
