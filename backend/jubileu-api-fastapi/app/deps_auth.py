...
from app.modules.auth.deps import AuthUser, get_current_user, get_operator_user, require_roles

ALLOWED_ROLES = {"admin", "treinador", "auxiliar", "user"}

__all__ = ["ALLOWED_ROLES", "AuthUser", "get_current_user", "get_operator_user", "require_roles"]
