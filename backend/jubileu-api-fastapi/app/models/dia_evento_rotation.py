...
from app.models.dia_evento_enums import RotacaoSorteioStatusEnum
...
class EventoRotacaoEstado(Base):
    ...
    evento: Mapped["Evento"] = relationship("Evento", back_populates="rotacao_estado")
...
class EventoRotacaoSorteio(Base):
    ...
    evento: Mapped["Evento"] = relationship("Evento", back_populates="rotacao_sorteios")
