...
|---|---|---|---|
| v0.3.x | Evento canonico, Usuario, Security Gate e release imutavel | RC3 rejeitado no rehearsal; RC4 em preparacao; producao NO-GO | Sem target date por decisao do responsavel |
